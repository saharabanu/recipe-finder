          ...
          <div>
            <div className="space-y-4">
              ...
              <p className="text-justify text-gray-500">
                ...
                ad, facilisis scripserit dissentiunt no qui. Eam ea illum
                indoctum mediocritatem. Eam graece nusquam ei, eos at pertinacia
                appellantur, usu meliore feugait in. Te dolorum aliquando pri.
                Ex stet moderatius est, cu probo copiosae sed. Cum erroribus
              ...
              <p className="text-gray-500">
                Elit solet eu has, in has paulo debitis recteque. Cu pri
                apeirian vituperata, justo nostro inermis sit an. Qui zril
                contentiones ne, sanctus probatus ullamcorper eam at.
              </p>
              <p className="text-gray-500">E-mail: abc@qodeinteractive.com</p>
            </div>
          </div>
        </div>
        <div className="my-10">
